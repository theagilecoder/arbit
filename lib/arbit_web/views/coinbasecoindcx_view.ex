defmodule ArbitWeb.CoinbasecoindcxView do
  ...
  @doc """
  Filters TUSD quoted coins from all results and sorts in descending order of difference
  """
  def filter_tusd_quotes(results) do
    results
  ...
  @doc """
  Filters USDC quoted coins from all results and sorts in descending order of difference
  """
  def filter_usdc_quotes(results) do
    results
